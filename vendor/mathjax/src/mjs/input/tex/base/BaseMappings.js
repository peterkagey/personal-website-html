...
new sm.CommandMap('macros', {
    ...
    it: [BaseMethods.SetFont, VARIANT.MATHITALIC],
    ...
    acute: [BaseMethods.Accent, '00B4'],
    grave: [BaseMethods.Accent, '0060'],
    ddot: [BaseMethods.Accent, '00A8'],
    dddot: [BaseMethods.Accent, '20DB'],
    ddddot: [BaseMethods.Accent, '20DC'],
    tilde: [BaseMethods.Accent, '007E'],
    bar: [BaseMethods.Accent, '00AF'],
    breve: [BaseMethods.Accent, '02D8'],
    check: [BaseMethods.Accent, '02C7'],
    hat: [BaseMethods.Accent, '005E'],
    vec: [BaseMethods.Accent, '2192', false],
    dot: [BaseMethods.Accent, '02D9'],
    widetilde: [BaseMethods.Accent, '007E', true],
    ...
    hfil: BaseMethods.HFill,
    hfilll: BaseMethods.HFill,
    bmod: [
        BaseMethods.Macro,
        '\\mmlToken{mo}[lspace="' +
            THICKMATHSPACE +

...
var AbstractMmlNode = (function (_super) {
        ...
        try {
            for (var _e = __values(Object.keys(attributes)), _f = _e.next(); !_f.done; _f = _e.next()) {
                ...
                if (Object.hasOwn(defaults, key) ||
                    ...
                    if (!((_c = (_b = AbstractMmlNode.noInherit[node]) === null || _b === void 0 ? void 0 : _b[this.kind]) === null || _c === void 0 ? void 0 : _c[key])) {
    ...
    AbstractMmlNode.prototype.verifyAttributes = function (options) {
        ...
        if (options.checkAttributes) {
            ...
            try {
                for (var _b = __values(attributes.getExplicitNames()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var name_4 = _c.value;
                    if (name_4.substring(0, 5) !== 'data-' &&
                        attributes.getDefault(name_4) === undefined &&
        ...
        if (options.checkMathvariants) {
            ...
            if (variant &&
                !exports.MATHVARIANTS.has(variant) &&

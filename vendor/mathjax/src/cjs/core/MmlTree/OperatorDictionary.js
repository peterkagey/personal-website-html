...
exports.OPTABLE = exports.MMLSPACING = exports.RANGES = exports.MO = void 0;
exports.OPDEF = OPDEF;
...
function getRange(text) {
    var e_1, _a;
    var def = exports.OPTABLE.infix[text] || exports.OPTABLE.prefix[text] || exports.OPTABLE.postfix[text];
    if (def) {
        return [0, 0, def[2], 'mo'];
    }
    ...
    return [0, 0, MmlNode_js_1.TEXCLASS.REL, 'mo'];
}
exports.MMLSPACING = [
    [0, 0],
    [1, 2],

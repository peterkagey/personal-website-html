...
exports.TagFormatConfiguration = void 0;
...
function tagformatConfig(config, jax) {
    ...
    var TagClass = Tags_js_1.TagsFactory.create(jax.parseOptions.options.tags)
        .constructor;
    var TagFormat = (function (_super) {
        ...
        TagFormat.prototype.formatRef = function (tag) {
            var ref = jax.parseOptions.options.tagformat.ref;
...
exports.TagFormatConfiguration = Configuration_js_1.Configuration.create('tagformat', (_a = {},
    _a[HandlerTypes_js_1.ConfigurationType.CONFIG] = [tagformatConfig, 10],

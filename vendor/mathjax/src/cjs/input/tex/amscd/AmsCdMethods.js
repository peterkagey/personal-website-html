...
var AmsCdMethods = {
    ...
    arrow: function (parser, name) {
        ...
        var mml;
        var hdef = { minsize: top.getProperty('minw'), stretchy: true };
        var vdef = {
    ...
    minCDarrowwidth: function (parser, name) {
        parser.stack.env.CD_minw = parser.GetDimen(name);
    },
    minCDarrowheight: function (parser, name) {

...
exports.Styles = exports.WSC = exports.TRBL = void 0;
exports.TRBL = ['top', 'right', 'bottom', 'left'];
exports.WSC = ['width', 'style', 'color'];
        ...
        for (var parts_1 = __values(parts), parts_1_1 = parts_1.next(); !parts_1_1.done; parts_1_1 = parts_1.next()) {
            ...
            try {
                for (var _c = (e_9 = void 0, __values(Object.keys(FONT))), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var name_1 = _d.value;
                    if ((Array.isArray(value[name_1]) || value[name_1] === '') &&
                        part.match(FONT[name_1])) {
...
var Styles = (function () {
    ...
    Styles.prototype.sanitizeValue = function (text) {
    ...
    Object.defineProperty(Styles.prototype, "cssText", {
        get: function () {
            ...
            var styles = [];
            try {
                for (var _d = __values(Object.keys(this.styles)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var name_2 = _e.value;
                    var parent_1 = this.parentName(name_2);
                    var cname = name_2.replace(/.*-/, '');
                    if (!this.styles[parent_1] ||
                        !((_c = (_b = Styles.connect[parent_1]) === null || _b === void 0 ? void 0 : _b.children) === null || _c === void 0 ? void 0 : _c.includes(cname))) {
                        styles.push("".concat(name_2, ": ").concat(this.styles[name_2], ";"));
                    }
                }
            }
    ...
    Object.defineProperty(Styles.prototype, "styleList", {
        get: function () {

...
exports.StyleJsonSheet = void 0;
var StyleJsonSheet = (function () {
    function StyleJsonSheet(styles) {
        if (styles === void 0) { styles = null; }
        this.styles = {};
        this.addStyles(styles);
    }
    Object.defineProperty(StyleJsonSheet.prototype, "cssText", {
        get: function () {
    ...
    StyleJsonSheet.prototype.addStyles = function (styles) {
        var e_1, _a;
        if (!styles)
            return;
        try {
    ...
    StyleJsonSheet.prototype.removeStyles = function () {
        var e_2, _a;
        var selectors = [];
    ...
    StyleJsonSheet.prototype.clear = function () {
        this.styles = {};
    };
    StyleJsonSheet.prototype.getStyleString = function () {
        return this.getStyleRules().join('\n\n');
    };
    StyleJsonSheet.prototype.getStyleRules = function () {
        var e_3, _a;
    ...
    StyleJsonSheet.prototype.getStyleDefString = function (styles) {
        var e_4, _a;
    ...
    return StyleJsonSheet;
}());
exports.StyleJsonSheet = StyleJsonSheet;

...
var Hoverer = (function (_super) {
    ...
    function Hoverer(document, pool, region, node, nodeQuery, nodeAccess) {
        var _this = _super.call(this, document, pool, region, node) || this;
...
var FlameHoverer = (function (_super) {
    ...
    function FlameHoverer(document, pool, _ignore, node) {
        var _this = _super.call(this, document, pool, new Region_js_1.DummyRegion(document), node, function (x) { return _this.highlighter.isMactionNode(x); }, function () { }) || this;
        _this.document = document;
        _this.pool = pool;
        _this.node = node;
        return _this;

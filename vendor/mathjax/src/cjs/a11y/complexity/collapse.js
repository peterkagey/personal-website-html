...
var Collapse = (function () {
    function Collapse(visitor) {
        ...
        this.collapse = new Map([
            [
                'fenced',
                function (node, complexity) {
                    complexity = _this.uncollapseChild(complexity, node, 1);
                    if (complexity > _this.cutoff.fenced &&
            ...
            [
                ...
                function (node, complexity) {
                    if (_this.canUncollapse(node, 2, 2)) {
                        ...
                        var text = marker[node.attributes.get('data-semantic-role')] ||
                            marker.value;
            ...
            [
                'integral',
                function (node, complexity) {
                    if (complexity > _this.cutoff.integral ||
                        !node.isKind('mo')) {
                        var id = _this.splitAttribute(node, 'content').pop();
                        var op = _this.findChildText(node, id);
                        complexity = _this.recordCollapse(node, complexity, op);
    ...
    Collapse.prototype.canUncollapse = function (node, n, m) {
        ...
        if (this.splitAttribute(node, 'children').length === m) {
            var mml = node.childNodes.length === 1 && node.childNodes[0].isInferred
                ? node.childNodes[0]
                : node;
    ...
    Collapse.prototype.makeCollapse = function (node, id) {
        var oldCount = null;
        if (id === null) {
            id = this.idCount;
        }
    ...
    Collapse.prototype.makeAction = function (node) {
        ...
        var variant = node.getProperty('collapse-variant')
        ...
        var maction = factory.create('maction', {
            ...
            factory.create('mtext', __assign({ mathcolor: 'blue' }, variant), [
    ...
    Collapse.prototype.addMrow = function (node) {
        ...
        try {
            for (var _b = __values(Object.keys(attributes)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var name_1 = _c.value;
                if (name_1.substring(0, 14) === 'data-semantic-' ||
                    name_1.substring(0, 12) === 'data-speech-' ||
                    name_1.substring(0, 5) === 'aria-' ||
                    name_1 === 'role') {
